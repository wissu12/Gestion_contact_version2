...
<head>
    ...
    <title>modifier mon contact</title>
                                            ...
                                            <div class="container2">
                                                ...
                                                <form action="Modifier" method="POST"  enctype="multipart/form-data">
                                                    ...
                                                    <div class="profile-box">
                                                        <img src="Contact/images/<%= request.getAttribute("photo") %>" alt="" class="profile-pic">
                                                        <input type="file" value="<%= request.getAttribute("nom") %>" name="photo" id="profile">
                                                        <label for="profile" id="uploadBtn">Choose photo</label>
                                                    </div>
                                                  <input type="hidden" value="<%= request.getParameter("id") %>" name="id_contact">
                                          
                                                    <div class="row">
                                                        <div class="t-input inline-input">
                                                            <input id="nom" type="text" name="nom" value="<%= request.getAttribute("nom") %>" required autofocus placeholder=".">
                                                            <label for="nom">Nom</label>
                                                            <div class="b-line"></div>
                                                        </div>
                                                        <input id="id" type="hidden" name="id" value="<%= request.getAttribute("id") %>" required>
                                                        <div class="t-input inline-input">
                                                            <input id="prenom" type="text" name="prenom" value="<%= request.getAttribute("prenom") %>" required placeholder=".">
                                                    ...
                                                    <div class="row">
                                                        <div class="t-input inline-input">
                                                            <input id="email" type="email" name="email" value="<%= request.getAttribute("email") %>" required autofocus placeholder=".">
                                                            <label for="email">Email</label>
                                                            <div class="b-line"></div>
                                                        </div>
                                                        <div class="t-input inline-input">
                                                            <input id="tel" type="text" name="tel" value="<%= request.getAttribute("tel") %>" required placeholder=".">
                                                    ...
                                                    <div class="row">
                                                        <div  style="width:160px;"class="t-input inline-input">
                                                            <input  id="adresse" type="text" name="adresse" value="<%= request.getAttribute("adresse") %>" required placeholder=".">
